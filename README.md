...
🔭 Currently Principal Data Scientist at [Synapse Analytics](https://synapse-analytics.io/)  
...
### [`ropensci/dbparser`](https://github.com/ropensci/dbparser) — R package · 50K+ downloads
Open-source package that parses and integrates heterogeneous public databases into one unified object model, so downstream analysis is written once regardless of source. Peer-reviewed and hosted by **rOpenSci**. I co-developed it and set the research direction, feature priorities and testing strategy.
*The lesson generalises: the highest-leverage work is often the integration layer nobody wants to own.*

### [`Chemogenomic-DTI-Prediction-Methods`](https://github.com/alizat/Chemogenomic-DTI-Prediction-Methods) — ⭐ 48 · 🍴 14
...
### [`Life-with-Graphs`](https://github.com/alizat/Life-with-Graphs) — networks
...
### [`Life-with-LLMs`](https://github.com/alizat/Life-with-LLMs) — GenAI
...
<details>
<summary><b>Also here</b> — competitions, scrapers and tooling</summary>

- [`CAFA-6-Protein-Function-Prediction`](https://github.com/alizat/CAFA-6-Protein-Function-Prediction) — Kaggle extreme multi-label classification (26K labels). EDA and feature-engineering pipeline.
- [`bggscraper`](https://github.com/alizat/bggscraper) — scraping toolkit built on the BoardGameGeek XML API. Data acquisition when no dataset exists is a skill in itself; I've used the same approach to build a used-car pricing dataset from classifieds when the market had none.
- [`heroic_surfer`](https://github.com/alizat/heroic_surfer) — scraped corpus feeding an LLM-powered Shiny app for exploring a self-development content library.
- [`my_r_snippets`](https://github.com/alizat/my_r_snippets) — R snippets. Free to copy.
...
- *Drug–Target Interaction Prediction via Class Imbalance-Aware Ensemble Learning* — **BMC Bioinformatics**, 2016

Full list on [ResearchGate](https://www.researchgate.net/profile/Ali-Ezzat-2).

---

## 🛠 Toolkit

`Python` `R` `SQL` `MATLAB` · `PyTorch` `scikit-learn` `XGBoost` `Transformers` `pandas` `NumPy`
`Docker` `Git` `MLflow` `Spark` `AWS` `Azure` `Neo4j` · `Shiny` `Plotly` `ggplot2` `Leaflet`
...
- **Email:** aliezzat1985 AT gmail DOT com
- **ResearchGate:** [Ali Ezzat](https://www.researchgate.net/profile/Ali-Ezzat-2)
